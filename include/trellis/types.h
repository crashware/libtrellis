...
#ifndef TRELLIS_TYPES_H
#define TRELLIS_TYPES_H
...
#define TRELLIS_FINGERPRINT_LEN 32

typedef struct trellis_fingerprint {
    uint8_t bytes[TRELLIS_FINGERPRINT_LEN];
} trellis_fingerprint_t;
...
typedef void (*trellis_free_fn)(void *ptr);

#ifdef __cplusplus
}
#endif

#endif /* TRELLIS_TYPES_H */
